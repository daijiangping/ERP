...
<div class="layui-form-item" style="text-align: left;margin-left: 20px">
    ...
    <button class="layui-btn" onclick="location.href='${pageContext.request.contextPath}/page/caigou_tuihuo_shenqing'">
        <i class="layui-icon">&#xe608;</i> 新增退货单
    </button>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: '订货日期', title: '退货日期', sort: true,}
            , {field: '送货日期', title: '付款期限', sort: true,}
            , {field: '供应商', title: '供应商 ', sort: true,}
            , {field: '应付金额', title: '应付金额 ', sort: true,}
            , {field: '预付定金', title: '预付定金 ', sort: true,}
            , {field: '制单', title: '制单 ', sort: true,}
            , {field: '经手人', title: '经手人 ', sort: true,}
            , {field: '审核', title: '审核 ', sort: true,}
            , {field: '进度', title: '进度', sort: true,}
            , {field: 'weal2th', title: '操作', templet: "#menu"}
        ]]
    });
    var fun = {
        detail: function () {
            common.openHtml("详情", "${pageContext.request.contextPath}/page/caigou_tuihuo_shenqing", ['95%', '95%'])
        }, shenhe: function () {

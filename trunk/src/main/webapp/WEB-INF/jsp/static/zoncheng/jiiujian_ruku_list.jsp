...
<div class="layui-form-item" style="text-align: left;margin-left: 20px">
    <div class="layui-btn-group">
        <button class="layui-btn" onclick="location.href='${pageContext.request.contextPath}/page/jiiujian_ruku'">
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: '订货日期', title: '入库类型', sort: true,}
            , {field: '送货日期', title: '入库日期', sort: true,}
            , {field: '制单1', title: '部门 ', sort: true,}
            , {field: '制单2', title: '制单 ', sort: true,}
    ...
    var fun = {
        detail: function () {
            common.openHtml("详情", "${pageContext.request.contextPath}/page/jiiujian_ruku", ['95%', '95%'])
        },shenhe: function () {

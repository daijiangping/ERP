...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {
                field: '', title: '维修班组', templet: function (d) {
                    return "机修组";
                }
            }
            , {
                field: 'cph', title: '产品问题次数', templet: function (d) {
                    return "10";
                }
            }, {
                field: 'cph', title: '驾驶员原因次数', templet: function (d) {
                    return "2";
                }
            }, {
                field: 'cph', title: '维修工原因', templet: function (d) {
                    return "2";
                }
            }, {
                field: 'cph', title: '系统判断有误', templet: function (d) {
                    return "3";
                }
            }, {
                field: 'cph', title: '维修次数', templet: function (d) {
                    return "1203";
                }
            }, {
                field: 'cph', title: '返修率', templet: function (d) {
                    return "30%";
                }
            }

                ...
                <div class="layui-colla-content layui-show">
                    <table class="layui-table" style="color: black" lay-skin="nob">
                        ...
                        <tr>
                            ...
                            <td align="left" class="t_blue">李晓红</td>


                        </tr>
                        <tr>

                            <td align="right" class="t_t">检测日期:</td>
                            <td align="left" class="t_blue">2017-12-26 11:55</td>

                            <td align="right" class="t_t">需要维修:</td>
                            <td align="left" class="t_blue"><span class="layui-badge">需要</span></td>

                            <td align="right" class="t_t">需要外修:</td>
                            <td align="left" class="t_blue"><span class="layui-badge">需要</span></td>
                            <td align="right" class="t_t">报修检测状态:</td>
                            <td align="left" class="t_blue">已检测</td>

...
<div class="layui-form-item" style="text-align: left;margin-left: 20px">
    <div class="layui-btn-group">
        <button class="layui-btn"
                onclick="location.href='${pageContext.request.contextPath}/page/chanpin_caifen_order'">
            <i class="layui-icon">&#xe608;</i> 新增拆分
        </button>
        <button class="layui-btn">
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'fsrq', title: '拆分日期', sort: true,}
            ...
            , {field: 'je', title: '金额', sort: true, templet: "#menu"}
        ]]
    });
    var fun = {
        detail: function () {
...
<script type="text/html" id="menu">
    <button class="layui-btn layui-btn-xs"
            onclick="location.href='${pageContext.request.contextPath}/page/caigou_jinhuo_order'">详情
    </button>
</script>

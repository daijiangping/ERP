...
<div class="order">
    ...
    <fieldset class="layui-elem-field">
        <legend style="color: #FF7F00">产品组装单</legend>
        <div class="layui-field-box">
            ...
            <div class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">组装仓库:</label>
                    <div class="layui-input-inline">
                        <select name="" >
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            {field: 'no', title: '产品编号', sort: true, edit: true}
            , {field: 'ck', title: '仓库 ', sort: true, edit: true}
            , {field: 'ckhw', title: '货位 ', sort: true, edit: true}
            , {field: 'name', title: '产品名称', sort: true, edit: true}
    ...
    var fun = {
        sh: function () {
            ...
            common.openHtml("选择产品", "${pageContext.request.contextPath}/page/select_order", ['100%', '100%'])
        }
    }
</script>

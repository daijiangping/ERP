...
<div class="order">
    ...
    <fieldset class="layui-elem-field">
        <legend style="color: #FF7F00">库存报溢单</legend>
        <div class="layui-field-box">
            <%--top--%>
            <div class="layui-form">
                <div class="layui-form-item">
                    <label class="layui-form-label">报溢日期:</label>
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">报溢人:</label>
                    <div class="layui-input-inline">
            ...
            <div class="layui-form layui-form-pane">
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label" style="width: 250px">
                       <img
                            src="${pageContext.request.contextPath}/resources/icon/cp.png" height="25">&nbsp;选择产品
                    </label>
                    <div class="layui-input-inline">

                        <input type="text" name="username" lay-verify="required" placeholder="产品编号/名称/条形码"
                               autocomplete="off" class="layui-input">

                    </div>
                    <label class="layui-form-label">报溢数量</label>
                    <div class="layui-input-inline">
                        <input type="text" name="username" lay-verify="required" value="1" class="layui-input">
                    </div>
                    <label class="layui-form-label">报溢仓库</label>
                    <div class="layui-input-inline">
                        <select name="">
                    ...
                    <label class="layui-form-label">报溢货位</label>
                    <div class="layui-input-inline">
                        <select name="">
                    ...
                    <label class="layui-form-label">报溢批次</label>
                    <div class="layui-input-inline">
                        <select name="">
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'guig1', title: '报溢仓库', sort: true, edit: true,}
            , {field: 'color1', title: '报溢货位', sort: true, edit: true}
            , {field: 'pinpai1', title: '报溢批次', sort: true, edit: true}

...
<div class="layui-form-item" style="text-align: left;margin-left: 20px">
    <div class="layui-btn-group">
        <button class="layui-btn" onclick="location.href='${pageContext.request.contextPath}/page/kucun_pandian_order'">
            <i class="layui-icon">&#xe608;</i> 新增盘点单
        </button>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'dbr2q', title: '盘点日期', sort: true,}
            , {field: 'dbb1m', title: '盘点部门 ', sort: true,}
    ...
    var fun = {
        detail: function () {
            common.openHtml("详情", "${pageContext.request.contextPath}/page/kucun_pandian_order", ['90%', '95%'])
        }, shenhe: function () {

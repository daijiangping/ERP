...
<div class="layui-form-item" style="text-align: left;margin-left: 20px">
    <button class="layui-btn" onclick="location.href='${pageContext.request.contextPath}/page/wuzhi_diaobo_order'">
        <i class="layui-icon">&#xe608;</i> 新增调拨
    </button>
...
<script>
    ...
    var fun = {
        detail: function () {
            common.openHtml("详情", "${pageContext.request.contextPath}/page/wuzhi_diaobo_order", ['95%', '95%'])
        }
    }
</script>

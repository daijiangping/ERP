...
<div class="order">
    ...
    <fieldset class="layui-elem-field">
        <legend style="color: #FF7F00">物资调拨单</legend>
        <div class="layui-field-box">
            ...
            <div class="layui-form">
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">调拨部门:</label>
                    <div class="layui-input-inline">
                        <select>
            ...
            <div class="layui-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">调出货位</label>
                    <div class="layui-input-inline">
                        <select name="">
                    ...
                    <label class="layui-form-label">调出批次</label>
                    <div class="layui-input-inline">
                        <select name="">
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">调入货位</label>
                    <div class="layui-input-inline">
                        <select name="">
                            <option value="1">002</option>
                            <option value="2">003</option>
                    ...
                    <label class="layui-form-label">调入批次</label>
                    <div class="layui-input-inline">
                        <select name="">
                            <option value="1">201701</option>
                            <option value="2">201702</option>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'guig1', title: '调出仓库', sort: true, edit: true,}
            , {field: 'color1', title: '调出货位', sort: true, edit: true}
            , {field: 'pinpai1', title: '调出批次', sort: true, edit: true}
            , {field: 'guig1', title: '调入仓库', sort: true, edit: true,}
            , {field: 'color1', title: '调入货位', sort: true, edit: true}
            , {field: 'pinpai1', title: '调入批次', sort: true, edit: true}
            , {field: 'sl1', title: '操作数量', sort: true, edit: true}
            , {field: 'danjia1', title: '单价', sort: true, edit: true}
            , {field: 'danjia1', title: '新单价', sort: true, edit: true}

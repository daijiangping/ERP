...
<div class="layui-form-item" style="text-align: left;margin-left: 20px">
    <div class="layui-btn-group">
        <button class="layui-btn" onclick="location.href='${pageContext.request.contextPath}/page/kucun_baosun_order'">
            <i class="layui-icon">&#xe608;</i> 新增报损
        </button>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'dbrq', title: '报损日期', sort: true,}
            , {field: 'dbbm', title: '报损部门 ', sort: true,}
    ...
    var fun = {
        detail: function () {
            common.openHtml("详情", "${pageContext.request.contextPath}/page/kucun_baosun_order", ['95%', '95%'])
        }, shenhe: function () {

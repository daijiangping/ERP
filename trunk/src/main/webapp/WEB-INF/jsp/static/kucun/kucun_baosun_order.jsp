...
<div class="order">
    ...
    <fieldset class="layui-elem-field">
        <legend style="color: #FF7F00">库存报损单</legend>
        <div class="layui-field-box">
            <%--top--%>
            <div class="layui-form">
                <div class="layui-form-item">
                    <label class="layui-form-label">报损日期:</label>
            ...
            <div class="layui-form layui-form-pane">
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">报损仓库</label>
                    <div class="layui-input-inline">
                        <select name="">
                    ...
                    <label class="layui-form-label">报损货位</label>
                    <div class="layui-input-inline">
                        <select name="">
                    ...
                    <label class="layui-form-label">报损批次</label>
                    <div class="layui-input-inline">
                        <select name="">
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'guig1', title: '报损仓库', sort: true, edit: true,}
            , {field: 'color1', title: '报损货位', sort: true, edit: true}
            , {field: 'pinpai1', title: '报损批次', sort: true, edit: true}

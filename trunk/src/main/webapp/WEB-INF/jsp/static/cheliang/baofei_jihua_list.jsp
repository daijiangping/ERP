    ...
    <div class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="username" class="layui-input" placeholder="订单编号">
            </div>
...
<div class="layui-form-item" style="text-align: left;margin-left: 20px">
    <button class="layui-btn" onclick="location.href='${pageContext.request.contextPath}/page/baofei_jihua'">
        <i class="layui-icon">&#xe608;</i> 新增计划
    </button>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'dbrq', title: '报废日期', sort: true,}
            , {field: '1', title: '联系人', sort: true,}
            , {field: 'db2bm', title: '联系电话 ', sort: true,}
    ...
    var fun = {
        detail: function () {
            common.openHtml("详情", "${pageContext.request.contextPath}/page/baofei_jihua", ['95%', '95%'])
        }
    }
</script>

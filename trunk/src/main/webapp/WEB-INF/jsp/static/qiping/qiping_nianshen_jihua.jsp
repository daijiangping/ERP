...
<div id="jiance_win" style="display:none;">
    <table class="layui-table" lay-size="sm">
        <tr>
            <td align="right">当前年审日期:</td>
            <td>
                <input type="text" placeholder="当前年审日期" class="layui-input">
            </td>

        </tr>
        <tr>

            <td align="right">下次年审日期:</td>
            <td>
                <input type="text" placeholder="下次年审日期" class="layui-input">
            </td>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {
                field: 'cph', title: '计划年审日期', sort: true, templet: function (d) {
                    return "2017-01-02";
                }
            }  , {
                field: 'cph', title: '上次年审日期', sort: true, templet: function (d) {
                    return "2016-01-02";
                }
            }
            , {
    ...
    var fun = {
       jiance: function () {
            common.open("批量年审", "jiance_win", ['800px', '600px'])
        }
    }
</script>

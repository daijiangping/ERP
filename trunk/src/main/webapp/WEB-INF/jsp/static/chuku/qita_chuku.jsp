...
<div class="order">
    ...
    <fieldset class="layui-elem-field">
        <legend style="color: #FF7F00">其他出库单</legend>
        <div class="layui-field-box">
            ...
            <div class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="username" class="layui-input" value="陕A52235">
                    </div>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'c1khw', title: '批次 ', sort: true, templet: "#batch"}
            , {field: 'n1ame', title: '物资名称', sort: true, edit: true}
            , {field: 'd1w', title: '单位', sort: true, edit: true,}
            , {field: 'g1uig', title: '规格', sort: true, edit: true,}
            , {field: 'c1olor', title: '颜色', sort: true, edit: true}
            , {field: 'pi1npai', title: '品牌', sort: true, edit: true}
            , {field: 'sl1', title: '数量', sort: true, edit: true}
            , {field: 'danj1ia', title: '车牌号', sort: true, edit: true}
            , {field: 'weal2th11', title: '备注 ', sort: true, edit: true}
            , {field: 'weal2th1', title: '操作', templet: "#menu"}
        ]]
    });

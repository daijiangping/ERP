...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'no1', title: '单据编号', sort: true,}
            , {
                field: 'no1', title: '出库类型', sort: true, templet: function (d) {
                    var arr = ["维修", "保养"];
            ...
            , {field: '订货1日期', title: '出库日期', sort: true,}
            , {field: '1', title: '部门', sort: true}
            , {field: '应付1金额', title: '联系人 ', sort: true,}
            , {field: '预2付定金', title: '备注 ', sort: true,}
            , {field: '制单3', title: '制单 ', sort: true,}
            , {field: '经4手人', title: '经手人 ', sort: true,}
            , {field: '审5核', title: '审核 ', sort: true,}
            , {field: '进2度', title: '状态', sort: true,}
            , {field: 'weal2th', title: '操作', templet: "#menu"}
        ]]
    });
    var fun = {
        detail: function () {
            common.openHtml("详情", "${pageContext.request.contextPath}/page/qita_chuku", ['95%', '95%'])
        }, shenhe: function () {

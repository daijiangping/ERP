...
<div class="order">
    ...
    <fieldset class="layui-elem-field">
        <legend style="color: #FF7F00">物资领用单</legend>
        <div class="layui-field-box">
            ...
            <div class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select>
                            <option value="1">维修领料</option>
                            <option value="2">保养领料</option>
                            <option value="3">其他领料</option>
                        </select>
                    </div>
...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'ckhw', title: '批次 ', sort: true, templet: "#batch"}
            ...
            , {field: 'sl', title: '领用数量', sort: true, edit: true}
            , {field: 'cph', title: '车牌号', sort: true, edit: true}

...
<script>
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            ,{field: 'no', title: '车辆编号', sort: true,}
            , {field: '登记日期', title: '登记日期', sort: true,}
            , {field: '运营公司', title: '运营公司', sort: true,}
            , {field: '车型', title: '作业类别 ', sort: true,}
            , {field: '开工时间', title: '开工时间 ', sort: true,}
            , {field: '完工时间', title: '完工时间 ', sort: true,}
            , {field: '作业人', title: '作业人 ', sort: true,}
            , {field: '检验签字', title: '检验签字 ', sort: true,}
            , {field: '作业内容', title: '作业内容', sort: true,}
            , {field: '报修内容', title: '报修内容', sort: true,}

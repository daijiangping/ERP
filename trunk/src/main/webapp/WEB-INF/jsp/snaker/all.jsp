...
<html lang="en">
	<head>
    	...
    	<link rel="stylesheet" href="${ctx}/resources/snaker/styles/CleverTabs/context/themes/base/style.css" type="text/css" />
    	<link rel="stylesheet" href="${ctx}/resources/snaker/styles/CleverTabs/context/themes/base/jquery-ui.css" type="text/css" />
	    <script src="${ctx}/resources/snaker/styles/CleverTabs/scripts/jquery.js" type="text/javascript"></script>
	    <script src="${ctx}/resources/snaker/styles/CleverTabs/scripts/jquery-ui.js" type="text/javascript"></script>
	    <script src="${ctx}/resources/snaker/styles/CleverTabs/scripts/jquery.contextMenu.js" type="text/javascript"></script>
	    <script src="${ctx}/resources/snaker/styles/CleverTabs/scripts/jquery.cleverTabs.js" type="text/javascript"></script>
